...
namespace BrnShop.PayPlugin.Tenpay
{
    ...
    public class TenpayUtil
    {
        ...
        static TenpayUtil()
        {
            ...
            tenpay_return = string.Format("http://{0}/Tenpay/Return", BrnShop.Core.BSPConfig.ShopConfig.SiteUrl); ;
            tenpay_notify = string.Format("http://{0}/Tenpay/Notify", BrnShop.Core.BSPConfig.ShopConfig.SiteUrl);
        }
