    ...
    public partial class OrderController : BaseMobileController
    {
        ...
        public ActionResult SubmitOrder()
        {
            lock (_locker)
            {
                ...
                //验证已经通过,进行订单保存
                OrderInfo orderInfo = Orders.CreateOrder(WorkContext.PartUserInfo, selectedOrderProductList, singlePromotionList, fullShipAddressInfo, payPluginInfo, shipPluginInfo, payCreditCount, couponList, fullCut, "", new DateTime(1970, 1, 1), WorkContext.IP);
                if (orderInfo != null)
                {
                    int pCount = 0;
                    //删除剩余的满赠赠品
